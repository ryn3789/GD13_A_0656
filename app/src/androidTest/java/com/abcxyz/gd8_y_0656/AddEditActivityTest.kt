    ...
    fun addEditActivityTest() {
        ...
        val textInputEditText3 = onView(
            allOf(
                ...
                childAtPosition(childAtPosition(withId(R.id.layout_fakultas),0),0)
            )
        )
        ...
        val materialButton4 = onView(
            allOf(
                withId(R.id.btn_save), withText("simpan"),childAtPosition(allOf(withId(R.id.ll_button),childAtPosition(
        ...
        val textInputEditText4 = onView(
            allOf(
                ...
                childAtPosition(childAtPosition(withId(R.id.layout_prodi),0),0)
            )
        )
