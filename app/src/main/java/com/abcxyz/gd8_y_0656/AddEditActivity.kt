...
import com.abcxyz.gd8_y_0656.api.MahasiswaApi
import com.abcxyz.gd8_y_0656.models.Mahasiswa
...
class AddEditActivity : AppCompatActivity() {
    ...
    private fun createMahasiswa(){
        ...
        if(etNama!!.text.toString().isEmpty()){
            Toast.makeText(this@AddEditActivity, "Nama tdk blh kosong!", Toast.LENGTH_SHORT).show()
        }

        else if(etNPM!!.text.toString().isEmpty()){
            Toast.makeText(this@AddEditActivity, "NPM tdk blh kosong!", Toast.LENGTH_SHORT).show()
        }

        else if(edFakultas!!.text.toString().isEmpty()){
            Toast.makeText(this@AddEditActivity, "Fakultas tdk blh kosong!", Toast.LENGTH_SHORT).show()
        }

        else if(etProdi!!.text.toString().isEmpty()){
            Toast.makeText(this@AddEditActivity, "Prodi tdk blh kosong!", Toast.LENGTH_SHORT).show()
        }
        else {
            ...
            val stringRequest: StringRequest = object :
                StringRequest(Method.POST, MahasiswaApi.ADD_URL, Response.Listener { response ->
                    ...
                    if (mahasiswa != null)
                        Toast.makeText(this@AddEditActivity, "Data berhasil +", Toast.LENGTH_SHORT)
                            .show()
    ...
    private fun updateMahasiswa(id: Long){
        ...
        val stringRequest: StringRequest = object:
            StringRequest(Method.PUT, MahasiswaApi.UPDATE_URL + id,Response.Listener{response->
                ...
                if(mahasiswa != null)
                    Toast.makeText(this@AddEditActivity, "Data berhasil update", Toast.LENGTH_SHORT).show()
