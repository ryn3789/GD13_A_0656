package com.abcxyz.gd8_y_0656.adapters
...
import com.abcxyz.gd8_y_0656.AddEditActivity
import com.abcxyz.gd8_y_0656.MainActivity
import com.abcxyz.gd8_y_0656.R
...
class MahasiswaAdapter(private var mahasiswaList: List<Mahasiswa>, context: Context):RecyclerView.Adapter<MahasiswaAdapter.ViewHolder>(),Filterable {
    ...
    override fun onBindViewHolder(holder:  ViewHolder, position: Int){
        ...
        holder.btnDelete.setOnClickListener{
            ...
            materialAlertDialogBuilder.setTitle("Konfirmasi").setMessage("yakin ingin menghapus data ini?").setNegativeButton("No",null)
